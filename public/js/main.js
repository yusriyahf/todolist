...
function formatDate(datetime) {
	if(datetime.getDate() < 10) {
		var date = "0" + datetime.getDate() + "/" + datetime.getMonth() + "/" + datetime.getFullYear();
		console.log('date < 10')
	}
	if(datetime.getMonth() < 10) {
		var date = datetime.getDate() + "/0" + datetime.getMonth() + "/" + datetime.getFullYear();
...
function search(val) {
	...
	$.ajax({ 
		...
		error: (xhr, status, err) => { 
			...
			TaskList.html(`<li id="search-not-found"><h4>Didn't found any match!</h4></li>`); 
